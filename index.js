...
const SUB_PATH = process.env.SUB_PATH || 'sb';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '633d25bf-0607-41da-a633-e16dee1879e6'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'dFTAQ6yzMW0tl80dXs8chNh7Q5iAMWYF';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
